    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      <section className="bg-white py-24 pt-32 px-6">
        <div className="container mx-auto text-center">
          ...
          <button className="cta-button text-white font-semibold py-3 px-8 rounded-full text-lg shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">
            Get Started Today
          </button>
          ...
          <div className="md:w-1/2">
            ...
            <ul className="space-y-4 text-lg text-gray-600">
              <li className="flex items-start">
                ...
                <span>
                  You&apos;re wasting valuable time on manual, repetitive tasks
              ...
              <li className="flex items-start">
                <span className="mr-2 text-red-500 text-2xl">❌</span>
                <span>
                  Your team&apos;s communication is scattered across different
                  apps, leading to lost information.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 text-red-500 text-2xl">❌</span>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="italic text-gray-700">
                ...
                management. We&apos;ve increased our team&apos;s productivity by
                30% and communication has never been smoother. It&apos;s an
                essential tool for us now.&quot;
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-200">
              ...
              <button className="w-full cta-button text-white font-semibold py-3 px-8 rounded-lg shadow-md hover:shadow-xl focus:outline-none">
                Start Free Trial
              </button>
            </div>
            {/* Pro Plan */}
